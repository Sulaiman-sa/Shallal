...
const submitForm = (e) => {
    ...
    axios.patch('/updateFoodItem', JSON.parse(jsonUpdate)).then(res=> props.history.push('/manager')).catch(err => console.log(err))
    }
...
if(!load) {
    ...
    return ( <div>
            ...
            <Form onSubmit={submitForm}>
                ...
                <Input type="select" name="foodItem" id="foodItem" onChange={handleInputChange}>
                  {FoodItemsMenu()}
                </Input>
                </FormGroup>
                <FormGroup>
                ...
                <Input type="text" name="Description" id="Description"  onChange={handleInputChange} placeholder="Enter new Description" />
                </FormGroup>
                <FormGroup>
                <Label for="Price">Price</Label>
                <Input type="text" name="Price" id="Price"  onChange={handleInputChange} placeholder="Enter new Price" />
                </FormGroup>
                <FormGroup>
